...
sc_demographics_groups_years <- southcarolina_demographics %>%
...
ggplot(sc_demographics_groups_years, aes(x = Age, y = total_impressions, fill = Gender)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(
...
```{r}
ggplot(sc_demographics_groups_years, aes(x = Age, y = total_link_clicks, fill = Gender)) +
  geom_bar(stat = "identity", position = "dodge") +
...
```{r}
ggplot(sc_demographics_groups_years, aes(x = Age, y = total_reach, fill = Gender)) +
  geom_bar(stat = "identity", position = "dodge") +
...
```{r}
ggplot(sc_demographics_groups_years, aes(x = Age, y = CTR, fill = Gender)) +
  geom_bar(stat = "identity", position = "dodge") +
...
```{r}
ggplot(sc_demographics_groups_years, aes(x = Age, y = total_spend, fill = Gender)) +
  geom_bar(stat = "identity", position = "dodge") +
...
```{r}
n_unique_sports <- length(unique(sc_demographics_sports_groups_year$Sport))



ggplot(sc_demographics_sports_groups_year, aes(x = Age, y = total_impressions, fill = Gender)) +
  geom_bar(stat = "identity", position = "dodge") +
...
```{r}
ggplot(sc_demographics_sports_groups_year, aes(x = Age, y = total_link_clicks, fill = Gender)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Link Clicks by Age and Gender", x = "Age Group", y = "Link Clicks") +
  theme_minimal() +
  facet_wrap(~ Sport+ Year) +
  scale_fill_brewer(palette = "Set1")
```
